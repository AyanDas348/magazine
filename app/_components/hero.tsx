            ...
            <div className="p-10">
                <div className="py-14 px-20">
                    <h1 className="text-left flex flex-col w-fit">
                        <span className="font-bold text-8xl">Look First/</span>
                        <span className="font-bold text-8xl">Then Leap</span>
                    ...
                    <span id="searchBar">
                        <div className="outline-none overflow-visible relative mt-8 mb-6 items-center flex max-w-80 py-3 px-4 flex-nowrap cursor-pointer border rounded-[56px] bg-white shadow-md">
                            ...
                            <span className="text-[#28322c] block text-xl leading-6 ml-1 overflow-hidden whitespace-nowrap">Search Markets Here</span>
                        </div>
