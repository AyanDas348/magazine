    ...
    return (
        <div id="container" className="w-full h-full">
            <div id="content" className="xl:p-10 p-2">
                <section className="xl:mt-20 mt-4">
                    <div className="grid auto-rows-min relative">
                        <div className="mb-6 items-center xl:gap-x-5 gap-x-2 flex justify-start border-l border-black">
                            <h2 className="inline scroll-mt-32 break-words font-[600] text-xl xl:text-3xl pl-4">{title}</h2>
                            <ChevronRight className='w-10 h-10'/>
                        </div>
                    </div>
                    <div className="xl:mb-12 mb-3">
                            ...
                            {topics.map((topic) => {
                                return (
                                    <div key={topic.id} className="border-none cursor-pointer rounded-lg hover:bg-[#7c7c6c] px-6 py-4 hover:text-white transition-all">
                                        <li key={topic.id} className="xl:text-base text-sm">
                                            {topic.title}
                                        </li>
                                    </div>
                                )
